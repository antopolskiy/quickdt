...
public final class NumericBranch extends Branch {
	...
	public NumericBranch(Branch parent, final String attribute, final double threshold) {
	...
	public boolean decide(final Attributes attributes) {
		...
		if (!(value instanceof Number)) {
			throw new RuntimeException("Expecting a number as the value of " + attribute
					+ " but got " + value + " of type " + value.getClass().getSimpleName());
		}
