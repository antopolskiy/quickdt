...
public final class HashMapAttributes implements Attributes, Serializable {
	...
	private HashMap<String, Serializable> delegatedHashMap;
	...
	public HashMapAttributes() {
		delegatedHashMap = new HashMap<>();
	}

	public HashMapAttributes(Map<String, Serializable> map) {
		delegatedHashMap = new HashMap<>(map);
	}
	...
	public boolean equals(final Object o) {
		...
		if (!delegatedHashMap.equals(that.delegatedHashMap)) {
            return false;
        }
