...
public class TreeTests {
	...
	public static void main(String[] args) {
		...
		TreeBuilder treeBuilder = new TreeBuilder().maxDepth(4).ignoreAttributeAtNodeProbability(.7)
				.minInstancesPerCategoricalVariable(0);
	...
	private static Iterable<? extends AbstractInstance> getTrainingData(String filename)
			throws IOException {
